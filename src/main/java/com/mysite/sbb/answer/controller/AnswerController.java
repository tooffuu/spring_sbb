...
public class AnswerController {
    ...
    public String answermodify(@Valid AnswerForm answerForm, BindingResult bindingResult, @AuthenticationPrincipal SiteUser siteUser, @PathVariable("id") Integer id, Principal principal) {
        if (bindingResult.hasErrors()) {
            return "answer_form";
        }
